...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username, malloc_username_from_conf_file(), "Username hard coded in my_username() is not equal to username from conf/username.txt");
